...
# Options
model_type = 'cGAN_singlechannel_complex' # 'cGAN_complex' (performs motion correction on complex coil-combined data)
...
config.load.opt = 1 # load saved models (turn off to train from scratch)

config.data.dir = '\path\to\data'
